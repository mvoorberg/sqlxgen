...
WHERE TRUE
    ...
    -- genre / JSONB is not supported here
    AND (CAST(:homepage AS TEXT) IS NULL or homepage = :homepage)
    -- keywords / JSONB is not supported here
    ...
    -- production_companies / JSONB is not supported here
    -- production_countries / JSONB is not supported here
    ...
    -- spoken_languages / JSONB is not supported here
